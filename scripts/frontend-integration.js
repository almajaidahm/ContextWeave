 ...
 * This file demonstrates how to integrate Contextweavepro with a web frontend
 */

// For React/Vue/Angular applications
export class ContextweaveproClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ContextweaveproClient(provider, contractAddress);
