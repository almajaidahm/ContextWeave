...
const contractABI = require("../artifacts/contracts/Contextweavepro.sol/Contextweavepro.json").abi;

program
    .name("contextweavepro-cli")
    .description("CLI tool for Contextweavepro smart contract")
    .version("1.0.0");
